                                ...
                                <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                                    <div class="footer-single-col">
                                        ...
                                        <ul class="list-unstyled footer-nav-list mb-lg-0">
                                            ...
                                            <li><a href="#trainings" class="text-decoration-none">Trainings</a></li>
                                            <li><a href="#whats-new" class="text-decoration-none">What's New</a></li>
                                            <li><a href="contact" class="text-decoration-none">Contact Us</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
